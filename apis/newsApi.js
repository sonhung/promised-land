...
const DATA = [
  {
    ...
    source_url:
      "https://alonhadat.com.vn/-can-tien-sang-nhanh-can-nha-duong-to-ngoc-van-nha-moi-duc-1tret-2lau-thiet-ke-sang-tron-4860255.html",
    prop_type: "house",
  ...
  },
  {
    ...
    referer: "https://alonhadat.com.vn/nha-dat/can-ban/nha-mat-tien.html",
    source_url:
      "https://alonhadat.com.vn/ban-gap-2-can-nha-pho-kinh-doanh-thong-nhat-noi-dai-1tret-1lung-2lau--4863010.html",
    prop_type: "house",
    raw_address: "Đường Tô Ngọc Vân, Phường Thạnh Xuân, Quận 12, Hồ Chí Minh",
    direction: "_",
    country: "VN",
  ...
  },
  {
    ...
    referer: "https://alonhadat.com.vn/nha-dat/can-ban/nha-mat-tien.html",
    source_url:
      "https://alonhadat.com.vn/nha-3-lau-106m2-ngay-cho-hiep-binh-giam-400-trieu-cho-khach-thien-chi-0776613388-ms-diep-4763462.html",
    prop_type: "house",
    raw_address:
      "Đường Phạm Văn Đồng, Phường Hiệp Bình Chánh, Quận Thủ Đức, Hồ Chí Minh",
    direction: "Tây Bắc",
...
const newsApi = env => {
  ...
  const getNewsDetail = async (req, res) => {
    const { params: { id } = {} } = req;
    const data = find(DATA, function(o) {
      return o._id === id;
    });
    res.send({ data });
  };
